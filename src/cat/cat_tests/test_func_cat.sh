...
declare -a extra=(
"-s cat_tests/test_1_cat.txt"
"-b -e -n -s -t cat_tests/test_1_cat.txt"
"-t cat_tests/test_3_cat.txt"
"-n cat_tests/test_2_cat.txt"
"-n -b cat_tests/test_1_cat.txt"
"-s -n -e cat_tests/test_4_cat.txt"
"-n cat_tests/test_1_cat.txt"
"-n cat_tests/test_1_cat.txt"
"-n cat_tests/test_1_cat.txt cat_tests/test_2_cat.txt"
)
